...
export default function ClothForm(props) {
  ...
  // Sync clothes with parent order object when clothes change
  useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    setClothes((prev) => [
      ...prev,
      { type: clothType, quantity: parseInt(clothQuantity) },
    ]);
    setClothType("");
    setClothQuantity("");
  };
  ...
  return (
    <div className="w-full mx-auto mt-2 bg-gray-100 p-10 shadow-lg rounded-2xl md:mb-20">
      <Typography className="text-2xl font-semibold text-gray-700 text-center mb-4">
        Add Clothes
      </Typography>
              ...
              >
                ...
                <div className="flex gap-2 items-center">
                  <button
                    ...
                    className="text-white bg-green-700 rounded"
                  >
                    <Plus size={18} />
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="text-orange-600 rounded-md p-1"
                  >
                    <Trash size={20} />
                  </button>
                </div>
