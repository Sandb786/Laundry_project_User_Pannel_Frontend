        ...
        <div className="bg-gray-100 py-10 px-1 sm:px-8">
            ...
            <div className="overflow-y-auto pr-2 max-h-[70vh] sm:max-h-[600px] mx-auto bg-white rounded-t-3xl mt-1 px-4 sm:px-6">
                ...
                <div className="p-6 sm:p-10 space-y-10">
                    ...
                    <div>
                        <Typography variant="h6" className="font-semibold mb-4">Order Schedule</Typography>
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl shadow-sm border border-gray-200">
                        <Typography variant="h6" className="font-semibold mb-4 text-gray-700 border-b pb-2">
                            Price Details
                        </Typography>
                        <div className="text text-gray-700 space-y-3">
                            ...
                            <div className="flex justify-between border-t pt-2 font-medium text-black">
                    ...
                    {/* ========== Payment Method ========== */}
                    <div>
                        <Typography variant="h6" className="font-semibold mb-2">Payment Method</Typography>
